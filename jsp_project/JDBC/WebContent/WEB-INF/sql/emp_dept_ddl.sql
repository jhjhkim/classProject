CREATE TABLE project.dept ( 
 ...
 CREATE INDEX idx_emp_dept ON project.emp ( deptno );
 
 ALTER TABLE project.emp ADD CONSTRAINT fk_emp_dept 
FOREIGN KEY ( deptno ) REFERENCES project.dept( deptno ) 
ON DELETE NO ACTION 
ON UPDATE NO ACTION;
...
insert into project.emp values( 7788, 'SCOTT', 'ANALYST', 7566, DATE_ADD(STR_TO_DATE('13-7-1987','%d-%m-%Y'),INTERVAL -85 DAY)  , 3000, null, 20);
...
insert into project.emp values( 7654, 'MARTIN', 'SALESMAN', 7698, STR_TO_DATE('28-09-1981','%d-%m-%Y'), 1250, 1400, 30);
insert into project.emp values( 7844, 'TURNER', 'SALESMAN', 7698, STR_TO_DATE('8-9-1981','%d-%m-%Y'), 1500, 0, 30);
insert into project.emp values( 7876, 'ADAMS', 'CLERK', 7788, DATE_ADD(STR_TO_DATE('13-7-1987', '%d-%m-%Y'),INTERVAL -51 DAY), 1100, null, 20);
