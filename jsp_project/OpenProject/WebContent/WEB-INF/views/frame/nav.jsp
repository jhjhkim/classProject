...
<nav>
	<ul>
		<li><a href="${pageContext.request.contextPath}/member/reg.do">회원가입</a></li>
		...
		<li><a href="${pageContext.request.contextPath}/guestbook/list.do">방명록 보기</a></li>
		...
		<li><a href="${pageContext.request.contextPath}/guestbook/write.do">방명록 쓰기</a></li>
			<li><a
