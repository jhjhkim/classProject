...
<body>
	...
	성인 여부 판단 : ${member.age-1 > 18} / ${member.age-1 gt 19} / ${member.name eq '이강인'} / 
				${member.name eq '이강인' and member.age > 15} / 
				${member.age-1>18 ? '성인' : '미성년자'} / ${not empty list}<br>
