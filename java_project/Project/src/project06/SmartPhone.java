...
public class SmartPhone {
	...
	// 이름 입력시 공백에 대한 예외처리와 영문자와 한글만 허용하는 예외처리
	public String getName() throws BadInputException {
		String result;
		...
		// 공백일 경우 예외 발생
		if(result.isEmpty()) {
			BadInputException e = new BadInputException("공백");
			throw e;
		}
		// 숫자와 특수문자 입력시 예외발생
	...
	// 전화번호 예외처리
	public String getPhoneNumber() throws BadInputException {
		String result;
		// String phoneRegex = ...
	...
	public void addContact() {
		...
		if (numOfContact < ARRAY_SIZE) {
			...
			String message = "전화번호를 입력해주세요. (예. 010-0000-0000)";
